...
export default function UserManagement() {
  ...
  const deleteUser = trpc.administration.deleteUser.useMutation({ onSuccess: () => { setNotice("User deleted."); setError(""); refresh(); }, onError: mutationError => setError(mutationError.message) });
