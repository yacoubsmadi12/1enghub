...
function AssetCard({ asset, onOpen }: { asset: Asset; onOpen: (asset: Asset) => void }) {
  ...
  return <button onClick={() => { onOpen(asset); window.history.pushState({}, "", `/asset/${asset.id}`); window.dispatchEvent(new PopStateEvent("popstate")); }} className="asset-card text-left">
